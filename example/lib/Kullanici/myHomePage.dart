import 'package:example/Admin/admin_home.dart';
import 'package:example/Kullanici/bildirimler.dart';
import 'package:example/Kullanici/cart.dart';
import 'package:example/Kullanici/delivery.dart';
import 'package:example/Kullanici/favorites.dart';
import 'package:example/Kullanici/hakkimizda.dart';
import 'package:example/Kullanici/history.dart';
import 'package:example/Kullanici/itemdetails.dart';
import 'package:example/Kullanici/login.dart';
import 'package:example/Kullanici/messages.dart';
//import 'package:example/Kullanici/panel.dart';
import 'package:example/Kullanici/profile.dart';
import 'package:example/Tools/app_data.dart';
import 'package:example/Tools/app_methods.dart';
import 'package:example/Tools/app_tools.dart';
import 'package:example/Tools/firebase_methods.dart';
import 'package:example/Tools/store.dart';
      ...
      floatingActionButton: new Stack(
        ...
        children: <Widget>[
          new FloatingActionButton(
            onPressed: () {
              Navigator.of(context).push(new CupertinoPageRoute(
                  builder: (BuildContext context) => new ShoppingCarts()));
            },
        ...
        child: new Column(
          children: <Widget>[
            ...
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(new CupertinoPageRoute(
                    builder: (BuildContext context) => new ShoppingHistories()));
              },
            ),
            new Divider(),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(new CupertinoPageRoute(
                    builder: (BuildContext context) => new ShoppingProfile()));
              },
            ),
            new ListTile(
              leading: new CircleAvatar(
              ...
              onTap: () {
                Navigator.of(context).push(new CupertinoPageRoute(
                    builder: (BuildContext context) => new ShoppingDelivery()));
              },
            ),
            new Divider(),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(new CupertinoPageRoute(
                    builder: (BuildContext context) => new Hakkimizda()));
              },
              //
            ),
            new ListTile(
  ...
  checkIfLoggedIn() async {
    if (isLoggedIn == false) {
      bool response = await Navigator.of(context).push(new CupertinoPageRoute(
          builder: (BuildContext context) => new ShoppingLogin()));
